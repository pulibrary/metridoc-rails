...
ActiveAdmin.register Security::UserRole, as: "UserRole" do
  ...
  form do |f|
    ...
    f.has_many :user_role_sections, for: [:user_role_sections, f.object.user_role_sections_sorted],
      ...
      a.input :access_level, as: :radio, collection: Security::UserRole::ACCESS_LEVELS.map { |a| [t("phrases.access_levels.#{a}").to_s, a] }, include_blank: false, label: false
    end
